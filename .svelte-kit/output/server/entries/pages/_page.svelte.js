import { V as attr, _ as stringify, $ as bind_props, U as store_get, Z as attr_style, a0 as ensure_array_like, W as unsubscribe_stores } from "../../chunks/index2.js";
...
function Hovered_HOME($$renderer, $$props) {
  ...
  $$renderer.push(`<a class="station svelte-9oqwnm" data-sveltekit-noscroll=""${attr("href", `/stations/${stringify(slug)}`)}><b>${escape_html(city)}</b> <h4>${escape_html(name)}</h4> <b>${escape_html(country)}</b></a>`);
